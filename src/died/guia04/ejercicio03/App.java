...
public class App {
	public static void main(String[] args) {
		...
		for(int i=0;i<10;i++) 
		r1.agregar(new Temperatura(generadorAleatorio.nextDouble()*50,Escala.CELSIUS));
		
		for(int i=0;i<10;i++) 
		r2.agregar(new Temperatura(generadorAleatorio.nextDouble()*105,Escala.FAHRENHEIT));
		
		r1.imprimir();
		System.out.println("Promedio en "+r1.getCiudad()+" :"+r1.mediaAsCelsius() +" C°");
		System.out.println("Maximo en "+r1.getCiudad()+" :"+r1.maximo().asCelsius() +" C°");
		r2.imprimir();
